...
glColor3f(0.0,0.0,0.0);
 glLineWidth(2);
glPushMatrix();
//glScalef(5,5,5);//For Lake
glScalef(200,200,45);//For Lake Superior
//if(count%2!=0)glTranslatef(-0,-800,-0);//FOR Lake
if(count%2!=0)glTranslatef(-0.5,-40,0);
...
glScalef(200,200,45);//FOR Lake Superior
//if(count%2==0)glTranslatef(-0,-800,-0);//FOR LAKE
if(count%2==0)glTranslatef(-25,0,0);
for(int i=0;i<f_count;i++){
   glBegin(GL_LINE_LOOP);
