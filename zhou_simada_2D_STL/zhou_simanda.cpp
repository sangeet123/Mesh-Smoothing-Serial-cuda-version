...
void zhou_shimada(vertex_buffer* &d_vb, vertex_buffer* &output,vector<vector<int> >&fan,int size, int v_count)
{
vertex_buffer v0;
vertex_buffer v1;
vertex_buffer v2;
...
for(int i=0;i<v_count;i++){
   ...
   for(int j=2;j<count+2;j++){
      ...
      vr3.x=d_vb[fan[i][index]].x;
      vr3.y=d_vb[fan[i][index]].y;
